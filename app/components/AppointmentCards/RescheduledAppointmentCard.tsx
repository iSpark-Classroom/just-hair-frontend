...
const RescheduledAppointmentCard = () => {
  return (
    <div className="w-full flex  gap-4 items-center justify-between p-6 bg-amber-50 border border-amber-200 rounded-2xl">
      <div className="flex gap-4 items-center">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-3">
            <p className="text-xs font-medium text-amber-700 py-1 px-3 bg-amber-100 rounded-full">
              Rescheduled
            </p>
      ...
      <span className="font-bold text-neutral-700 text-base cursor-pointer underline decoration-solid hover:text-amber-900">
        View
      </span>
    </div>
  );
};
export default RescheduledAppointmentCard;
