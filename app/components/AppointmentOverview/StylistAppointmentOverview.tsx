    ...
    <div className="p-6 flex flex-col gap-6 rounded-2xl border border-neutral-200 bg-white">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex flex-col">
            <span className="font-bold text-xl text-neutral-800">207</span>
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm text-neutral-600">Reviews Received</p>
          </div>
        </div>
      </div>
    </div>
...
export default StylistAppointmentOverview;
